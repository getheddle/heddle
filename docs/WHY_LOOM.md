...
A Loom worker config is a YAML file containing a system prompt, typed
...
- You're building a consumer-facing SaaS product (Loom is infrastructure, not a product)
...
| | Loom | LangChain / LangGraph | CrewAI | AutoGen | Python script |
|---|---|---|---|---|---|
...
- **[Concepts](CONCEPTS.md)** — how Loom works, in plain language
