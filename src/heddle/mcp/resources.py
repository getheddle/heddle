...
Exposes files in a HEDDLE workspace directory as MCP resources with
...
Also listens on the NATS ``heddle.resources.changed`` subject for
external change notifications from HEDDLE workers (future use).
"""
