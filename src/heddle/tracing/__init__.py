"""
Heddle distributed tracing — optional OpenTelemetry integration.
...
Usage::
    ...
    from heddle.tracing import get_tracer, inject_trace_context, extract_trace_context

    tracer = get_tracer("heddle.pipeline")
