"""
App manifest schema for Heddle application bundles.

A Heddle app is a ZIP archive containing worker/pipeline/scheduler configs,
...
Manifest format::
    ...
    name: "myapp"
    version: "1.0.0"
    description: "My Heddle application"
...
# Known heddle extras (from pyproject.toml optional-dependencies).
...
class AppManifest(BaseModel):
    """Heddle application manifest.

    Describes the contents and metadata of a Heddle app bundle (ZIP archive).
