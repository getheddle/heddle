...
All Heddle configs are YAML files. This module validates them at load time so
...
See Also:
    ...
    heddle.scheduler.config — scheduler config validation
    heddle.mcp.config — MCP gateway config validation
"""
