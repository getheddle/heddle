...
Commands::
    ...
    heddle new worker     # scaffold a worker config
    heddle new pipeline   # scaffold a pipeline config
"""
...
def worker(  # noqa: PLR0912, PLR0915
    ...
    click.echo(f"    heddle validate {dest}")
    click.echo("    heddle workshop  # test it in the web UI")
    click.echo()
...
def pipeline(  # noqa: PLR0912, PLR0915
    ...
    from heddle.core.config import validate_pipeline_config
    ...
    click.echo(click.style("  Next steps:", fg="cyan"))
    click.echo(f"    heddle validate {dest}")
    click.echo("    heddle workshop  # visualize the pipeline")
    click.echo()
