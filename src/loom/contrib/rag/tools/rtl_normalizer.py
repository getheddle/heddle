"""
loom.contrib.rag.tools.rtl_normalizer
--------------------------------------
Generic RTL text normalization utility, optimized for Persian (Farsi) and
Arabic text as found in Telegram channel exports.
...
ARABIC_DIGITS = str.maketrans("\u06f0\u06f1\u06f2\u06f3\u06f4\u06f5\u06f6\u06f7\u06f8\u06f9", "0123456789")
...
def _detect_language_hint(text: str) -> str:
    ...
    if persian_ratio > 0.7:
        ...
        return "en"
    elif persian_ratio > 0.2 and ascii_ratio > 0.2:
        return "mixed"
    return "unknown"
