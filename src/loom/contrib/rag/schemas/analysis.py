"""
loom.contrib.rag.schemas.analysis
----------------------------------
...
class TrendSignal(AnalysisBlock):
    """
    A recurring topic or narrative pattern detected across >=1 channels
...
class CorroborationMatch(AnalysisBlock):
    """
    The same factual claim or event reported by multiple independent sources.
