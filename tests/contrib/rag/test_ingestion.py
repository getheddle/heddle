            ...
            [
                {
                    ...
                    "text": "Hello world from Telegram channel.",
                },
                {
                    "id": 2,
                    "type": "message",
                    ...
                    "text": "Another message with enough text for ingestion.",
                },
            ]
        )
        ...
        path = _make_export(
            [
                ...
                },
                {
                    ...
                    "date": "2026-03-01T11:00:00",
                    "date_unixtime": "1740830400",
                    "text": "A real message that should be included.",
                },
            ]
        )
        ingestor = TelegramIngestor(path, min_text_len=5).load()
            ...
            [
                {
                    ...
                    "date": "2026-03-01T10:00:00",
                    "date_unixtime": "1740826800",
                    "text": "Test message content here.",
                }
            ],
